...
- Add to turn prep context menu
    - Default routing is working fine. 
    
    - Optional submenu options to add directly to a specific plan, filtered by activity types

    - Change Default for new plans to put them at the top so that they are the default recipient of sent features.

- Collapsible favorites
    - Turns out they can get chonky pretty quick.
